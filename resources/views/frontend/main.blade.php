            ...
            <ul class="row">
                ...
                <li class="col-xl-3 col-lg-4 col-sm-4 col-6">
                    <div class="product-wrap">
                        ...
                        <div class="product-content">
                            <h3><a href="{{ route('productDetails',$product->slug) }}">{{ $product->title }}</a></h3>
                            <p class="pull-left">{{ '$'.$product->attribute->min('offer_price') }}
                            ...
                            <div class="modal-body d-flex">
                                ...
                                <div class="product-single-content w-50">
                                    ...
                                    <div class="rating-wrap fix">
                                        <span class="pull-left">{{ '$'.$product->attribute->min('offer_price') }}</span>
